  ...
  return (
    ...
    >
      {blockId && (
        <div 
          className={cn(
            "absolute -left-6 top-1.5 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity z-10",
      ...
      <NodeViewContent as={Tag} className="px-1 mx-0 my-0 placeholder:text-muted-foreground" />
    </NodeViewWrapper>
  )
}
